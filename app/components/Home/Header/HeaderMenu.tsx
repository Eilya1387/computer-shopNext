  ...
  return (
    <menu className="header-menu w-full h-[42px] md:h-[75px]">
      ...
      <div className="header-menu--mobile flex flex-row-reverse justify-between items-center md:hidden">
        <div className="header-menu__wrap__left w-[78px] h-10 flex items-center gap-2.5">
          <i className="header-menu__wrap__left--1 w-full h-full flex justify-center items-center p-1.5">
            <Image
              src="/Header/bb2423ec7e3cf88aac03f054fc77aafbc070500e.webp"
              alt="logo"
              width={44}
              height={44}
            />
        ...
        <div className="header-menu__wrap__right w-[128px] h-10 flex">
          <button className="header-menu__wrap__right--1 w-full h-full flex justify-center items-center">
            ...
            >
              <path
                d="M19.333 25.3333C22.6467 25.3333 25.333 22.647 25.333 19.3333C25.333 16.0195 22.6467 13.3333 19.333 13.3333C16.0193 13.3333 13.333 16.0195 13.333 19.3333C13.333 22.647 16.0193 25.3333 19.333 25.3333Z"
                stroke="#292D32"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
              <path
                d="M24.6196 25.7931C24.973 26.8598 25.7796 26.9665 26.3996 26.0331C26.9663 25.1798 26.593 24.4798 25.5663 24.4798C24.8063 24.4731 24.3796 25.0665 24.6196 25.7931Z"
                stroke="#292D32"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
      ...
      <div className="header-menu--md hidden md:flex lg:hidden h-full justify-between items-center">
        ...
        <i
          className="header-menu__icon__left--md w-[30%] h-full flex justify-center items-center cursor-pointer"
          onClick={onOpenSidebar}
        >
          <Image
            src="/Header/Category - Iconly Pro.webp"
            alt="menu"
            width={24}
            height={24}
          />
      ...
      <div className="header-menu--lg hidden lg:flex h-full justify-around items-center">
        ...
        <nav className="header-menu__navbar--lg flex justify-evenly items-center gap-5">
          ...
          <div className="navbar__item--dropdown relative">
            ...
            >
              <li className="nav-li py-2 px-4 hover:bg-gray-100 cursor-pointer first:rounded-t-lg">
                تستی
              </li>
              <li className="nav-li py-2 px-4 hover:bg-gray-100 cursor-pointer">
                تستی
              </li>
              <li className="nav-li py-2 px-4 hover:bg-gray-100 cursor-pointer">
                تستی
              ...
              <li className="nav-li py-2 px-4 hover:bg-gray-100 cursor-pointer last:rounded-b-lg">
                تستی
              </li>
            </ul>
          </div>
